const Checkout = ({
  ...
  return (
    <div className="bg-white rounded-lg p-6 shadow-lg">
      <h2 className="text-xl text-rose-700 font-bold text-red mb-4">
      ...
      {cart.length === 0 ? (
        <div className="flex flex-col items-center justify-center text-center py-8">
          ...
          <p className="text-rose-700">Your added items will appear here</p>
        </div>
      ) : (
        <>
            ...
            {cart.map((item, index) => (
              <div key={index} className="flex justify-between items-center border-b border-rose-100 pb-4">
                ...
                <button
                  ...
                  className="cursor-pointer active:scale-105 w-6 h-6 rounded-full border border-rose-700 flex items-center
                  justify-center text-rose-700 hover:border-rose-900 hover:text-rose-900
                  transition-colors"
                >
          ...
          <div className="flex justify-between mb-6">
            <p className="text-lg font-semibold text-rose-900">Order Total</p>
            <p className="font-bold text-2xl text-rose-900">${totalPrice.toFixed(2)}</p>
          </div>
          
          <div className="bg-rose-50 flex gap-2 items-center justify-center rounded-lg p-2 mb-6">
            <svg
                ...
                height="30"
            >
              <path d="M12 2a9 9 0 019 9c0 3.21-1.7 6.04-4.25 7.7A9.04 9.04 0 0112 20a9 9 0 110-18zm0 2a7 7 0 100 14 7 7 0 000-14zm-.5 4h1v4h-1V8zm0 6h1v2h-1v-2z" />
            </svg>
